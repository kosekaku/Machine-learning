...
def classify_images(images_dir, results_dic, model):
    ...
    """
      # loop through the results_dic to get the image path
    for key in results_dic:
        ...
        if any(pet_label == label for label in classifier_labels):
              # Add the classifier label and match indicator(1) to the results dictionary
              results_dic[key].extend([classifier_label,1])
        else:
              # Add the classifier label and mismatch indicator(0) to the results dictionary
